      ...
      <div className="col-xl-5">
        <div className="section-title-wrap wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
          <div className="section-title2">
            ...
            <h2>Why EvoShift is your top-choice</h2>
              ...
              <div className="row align-items-center">
                <div className="col-lg-7">
                  <div className="feature-content">
                    ...
                    <p>Welcome to EvoShift, where digital innovation meets straoi
                    ...
                    <ul>
                      <li>
                        ...
                        <div className="content">
                          ...
                          <p>Achieves optimal outcomes consistently, boasting an unparalleled track record for achieving success at the highest levels.</p>
                        </div>
                      </li>
                      <li>
                        <div className="check-icon">
                        ...
                        <div className="content">
                          ...
                          <p>Requires significant time and effort, demanding substantial resources or extended durations for completion.</p>
                        </div>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-7">
                  <div className="feature-content">
                    ...
                    <p>Utilize diverse tools for efficient access to cutting-edge technology in various domains.</p>
                    <ul>
                      <li>
                        <div className="check-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width={17} height={17} viewBox="0 0 17 17">
                        ...
                        <div className="content">
                          ...
                          <p>Leveraging cutting-edge tools and innovations for efficient, streamlined processes and enhanced productivity in contemporary workflows.</p>
                        </div>
                      </li>
                      <li>
                        <div className="check-icon">
                        ...
                        <div className="content">
                          ...
                          <p>Enhancing existing capabilities through updates, improvements, and advancements to elevate performance and user experience.</p>
                        </div>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-7">
                  <div className="feature-content">
                    ...
                    <p>
                      Optimal value, minimal expense—achieving efficiency without compromising quality or functionality.</p>
                    <ul>
                      <li>
                        <div className="check-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width={17} height={17} viewBox="0 0 17 17">
                        ...
                        <div className="content">
                          ...
                          <p>Cost-effective solutions tailored for maximum efficiency, providing optimal performance at a budget-friendly price point.</p>
                        </div>
                      </li>
                      <li>
                        <div className="check-icon">
                        ...
                        <div className="content">
                          ...
                          <p>Streamlined processes reduce both time and costs, ensuring efficiency and optimal resource allocation for maximum productivity.</p>
                        </div>
                      </li>
                    </ul>
                  </div>
