          ...
          <div className="row justify-content-center mb-70">
            <div className="col-lg-8">
              ...
              >
                ...
                <p>
                  Welcome to EvoShift, where digital innovation meets strategic
                  ...
                  >
                    ...
                    <div className="accordion-item">
                      <h2 className="accordion-header" id="faqheadingTwo">
                        ...
                        >
                          02. Is EvoShift suitable for my business?
                        </button>
                      </h2>
                      <div
                        id="faqcollapseTwo"
                      ...
                      >
                        <div className="accordion-body">
                          Certainly, The EvoShift's suitability for your business
