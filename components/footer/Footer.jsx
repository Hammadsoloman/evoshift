...
const services = [
  { title: "Web Development", url: "/service/web-development" },
  { title: "Quality Assurance", url: "/service/quality-assurance" },
  ...
  />*/}
              ...
              >
                <div className="footer-widget">
                  ...
                  <div className="content">
                    <p>
                      Welcome to EvoShift, where innovation meets our passion in
          ...
          <div className="footer-bottom">
            <div className="copyright-area">
              <p>
                Copyright {new Date().getFullYear()} <a href="#">EvoShift</a>
              </p>
            </div>
