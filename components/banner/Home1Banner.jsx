...
const Home1Banner = ({data}) => {
  ...
  // const tempFile = getFile(data.video.asset._ref, client.config());
                 ...
                 <Swiper {...settings} className="swiper banner-img-slider">
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/WebDevelopment.jpg" alt="" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/UIUX Design.jpg" alt="" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="assets/img/home1/Custom Software Development.jpg" alt="" />
                    </SwiperSlide>
                  </div>
                </Swiper> 
